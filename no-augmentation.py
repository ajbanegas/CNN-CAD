...
def plot_confusion_matrix(model_name, ypr):
  aux = class_names
  cm = confusion_matrix(valid_ds.class_names, ypr, labels=aux)
...
def evaluate_model(model_name, model, M):
  ...
  for i in range(M):
    score = model.evaluate(valid_ds, verbose=0)
...
for model_name in model_dict.keys():
  ...
  #plot_precision_recall(model_name, valid_ds.labels, ypr)

  # Classification report
  #print(classification_report(valid_ds.labels, ypr, target_names=class_names))
